...
import { ArrowRight, Truck, Award, Clock, Database, CheckCircle, Waves } from "lucide-react";
        ...
        <div className="relative container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90">
              RS Fisheries delivers premium quality seafood across multiple markets with digitized operations, ensuring consistency and reliability in every shipment.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-2 hover:border-primary transition-colors">
              ...
              <CardContent>
                <CardDescription>
                  Serving restaurants, retailers, and wholesalers across local, regional, and export-ready markets.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-primary transition-colors">
              ...
              <CardContent>
                <CardDescription>
                  Maintaining cold chain integrity and rigorous quality controls from source to delivery.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-primary transition-colors">
              ...
              <CardContent>
                <CardDescription>
                  Reliable logistics and fleet management ensuring your seafood arrives fresh and on schedule.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-primary transition-colors">
              ...
              <CardContent>
                <CardDescription>
                  Advanced CRM and inventory systems providing real-time tracking and transparent communication.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Featured Fish Types</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore our wide selection of premium seafood, available fresh or frozen to meet your business needs.
            </p>
          </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">Simple, transparent process from enquiry to delivery</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Submit your requirements through our enquiry form or contact us directly. We'll respond within 24 hours.
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Receive pricing, availability, and delivery options. Review and confirm your order with our team.
              </p>
            </div>
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Receive fresh seafood at your location with our reliable cold-chain logistics and tracking.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Why Choose RS Fisheries</h2>
